	...
	factory: (require) => {
		...
		*/
		...
		var remote_module_css_default = {
			...
			"task-toast-in": "bXyBIq_task-toast-in",
		...
		*/
		...
		//#endregion
		//#region src/client/TaskCompleteToast.tsx
		/**
		...
		* @returns the toast element.
		*/
		function TaskCompleteToast({ title, onDone }) {
			const [visible, setVisible] = (0, react.useState)(true);
			(0, react.useEffect)(() => {
				const timer = window.setTimeout(() => {
					setVisible(false);
			...
			if (!visible) return null;
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: remote_module_css_default.taskToast,
				role: "status",
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
					className: remote_module_css_default.taskToastTitle,
					children: "任务已完成"
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
					className: remote_module_css_default.taskToastDetail,
					children: title
				})]
			});
		}
		...
		var TurnCompleteWatcher = class {
			...
			*/
			ingestFrame(frame) {
				...
				return [{
					sessionId,
					title: this.titles.get(sessionId) ?? "会话"
				}];
			}
		};
		...
		*/
		...
		function showTaskCompleteToast(title) {
			const mount = document.createElement("div");
			document.body.appendChild(mount);
			const root = (0, react_dom_client.createRoot)(mount);
			root.render((0, react.createElement)(TaskCompleteToast, {
				title,
				onDone: () => {
					root.unmount();
					mount.remove();
    ...
    `;
			...
			ctx.effect(() => {
				...
				const titleOf = (sessionId) => {
					...
					return row === void 0 ? "" : row.displayTitle ?? "";
				};
