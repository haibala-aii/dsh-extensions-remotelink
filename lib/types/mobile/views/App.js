...
import { history as fetchHistory, listSessions, listWorkspaces, prompt } from "../api.js";
...
export function App() {
    ...
    return (_jsx("div", { className: "mobile", children: route.kind === 'workspaces'
            ? _jsx(WorkspaceRoster, { onPick: (workspace) => { setRoute({ kind: 'sessions', workspace }); } })
            : route.kind === 'sessions'
...
export function loadHistory(sessionId, beforeSeq) {
